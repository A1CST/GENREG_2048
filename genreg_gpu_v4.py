# ================================================================
# GENREG 2048 — GPU Evolver V4 (Evolved Reproduction)
# ================================================================
# Extends V3 with per-genome reproductive strategy parameters.
#
# V3 genome evolves: encoder, activation, controller, proteins.
# V4 genome ALSO evolves HOW it reproduces:
#   - mut_rate:  how often this genome's children mutate (0.01 - 0.15)
#   - mut_scale: how large the mutations are (0.01 - 0.5)
#   - explore:   probability of large "jump" mutations (0.0 - 0.3)
#
# These are heritable, mutable traits — just like proteins.
# Natural selection determines which reproductive strategy works:
#   - Exploiters: low mut_rate, low mut_scale → refine existing strategy
#   - Explorers:  high mut_rate, high explore → search for breakthroughs
#   - Both coexist. The population self-organizes its diversity.
#
# No hardcoded triggers. No tile-specific rules. The population
# discovers its own selection pressure.
# ================================================================
